                ...
                <div class="row g-0">
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                        <div style="max-width: 25rem;">
                            ...
                            <div class="mb-5">
                                <h2 class="color-900">Adelanto de Nomina:</h2>
                            </div>
                
                            <!-- List Checked -->
                            <ul class="mb-5">
                                <li class="mb-4">
                                    <span class="d-block fw-bold">Herramienta todo en uno</span>
                                    <span class="text-muted">Funciones asombrosas para hacer su vida más fácil y eficiente en el trabajo</span>
                                </li>
                
                                <li>
                                    <span class="d-block fw-bold">EAgregue y administre fácilmente sus servicios</span>
                                    <span class="text-muted">Reúne sus tareas, proyectos, líneas de tiempo, archivos y más</span>
                                </li>
                            </ul>
