<template>
  <jet-form-section @submitted="updatePassword">
    ...
    <template #description>
       Aseg&uacute;rese de que su cuenta est&eacute; usando una contraseña larga y aleatoria para mantenerse seguro.
    </template>
    ...
    <template #form>
      ...
      <div class="w-75">
        <div class="mb-3">
          <jet-label for="current_password" value="Actual Password" />
        ...
        <div class="mb-3">
          <jet-label for="password_confirmation" value="Confirmar Nuevo Password" />
