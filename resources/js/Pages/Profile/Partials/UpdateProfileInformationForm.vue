<template>
  <jet-form-section @submitted="updateProfileInformation">
    <template #title>
      Informaci&oacute;n de tu Perfil
    </template>

    <template #description>
       Actualice la informaci&oacute;n de perfil y la dirección de correo electrónico de su cuenta.
    </template>
    ...
    <template #form>
      ...
      <div class="w-75">
        <!-- Name -->
        <div class="mb-3">
          <jet-label for="name" value="Ingresa tu nombre" />
