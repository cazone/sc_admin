<template>
  <jet-action-section>
    ...
    <template #description>
       Administre y cierre la sesi&oacute;n de sus sesiones activas en otros navegadores y dispositivos.
    </template>
    ...
    <template #content>
      ...
      <div>
       Si es necesario, puede cerrar la sesi&oacute;n de todas las dem&aacute;s sesiones de su navegador en todos sus dispositivos. Si cree que su cuenta se ha visto comprometida, tambi&eacute;n debe actualizar su contraseña.
      </div>
          ...
          <div class="ms-2">
            ...
            <div>
              <div class="small font-weight-lighter text-muted">
                ...
                <span class="text-success font-weight-bold" v-if="session.is_current_device">Este dispoditivo</span>
                <span v-else>Activo desde {{ session.last_active }}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="d-flex mt-3">
        <jet-button @click="confirmLogout">
          Cerrar sesi&oacute;n en los otros navegadores
        </jet-button>
      </div>
      ...
      <jet-dialog-modal id="confirmingLogoutModal">
        ...
        <template #content>
         Ingrese su contraseña para confirmar que desea cerrar la sesi&oacute;n de sus otras sesiones de navegador en todos sus dispositivos.
